...
const MOCK_PRODUCTS: IProduct[] = [
  {
    ...
    images: [{ url: '/images/products/kiosk.jpg', alt: '스마트 키오스크', isMain: true }],
    ...
    rentalPlans: [
      ...
      },
      {
        ...
        maintenanceFee: 8000,
        deposit: 80000,
        benefits: ['프리미엄 설치', '월 2회 점검', '24시간 기술지원', '무료 업그레이드'],
      },
    ],
    partnerId: 'partner-1',
    tags: ['인기', '신제품'],
  ...
  },
  {
    ...
    images: [{ url: '/images/products/pos.jpg', alt: 'POS 시스템', isMain: true }],
